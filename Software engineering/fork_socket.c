...
//#define NULL 0
#define THEIRPORT xxxx    /* choose the port (in range 6900-6999) users will be sending to */
#define MYPORT yyyy  /* choose a port (in range 4000-4099) from which to send */
